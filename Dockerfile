...
COPY docs/IMPLEMENTATION_SPECIFICATION.md /app/IMPLEMENTATION_SPECIFICATION.md
COPY docs/PROJECT_DATA_SCIENCE_DATA_ENGINEERING_POSITIONING.md /app/PROJECT_DATA_SCIENCE_DATA_ENGINEERING_POSITIONING.md
COPY docs/PROJECT_ROADMAP.md /app/PROJECT_ROADMAP.md
